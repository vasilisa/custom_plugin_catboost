# This file is the actual code for the custom Python algorithm custom-catboost_catboost-regressor
...
class CustomPredictionAlgorithm(BaseCustomPredictionAlgorithm):    
    """
        Class defining the behaviour of `custom-catboost_catboost-regressor` algorithm:
